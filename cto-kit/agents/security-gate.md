...
- **Personal identity:** real email addresses, local filesystem paths that reveal a username (`/Users/<name>`, `/home/<name>`), OS usernames, and any handle the owner hasn't chosen to make public.
